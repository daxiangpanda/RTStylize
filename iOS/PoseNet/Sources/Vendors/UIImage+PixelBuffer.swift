...
extension UIImage {
    ...
    func grayImage() -> UIImage? {
        ...
        let grayContext = CGContext(data: nil, width: width, height: height, bitsPerComponent: 8, bytesPerRow: CVPixelBufferGetBytesPerRow(self.pixelBuffer()!), space: colorspace, bitmapInfo: 0)!
